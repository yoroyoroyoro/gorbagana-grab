  ...
  return (
    <div className="flex justify-center gap-12 mb-6">
      <div className="clean-card text-center">
        <div className="text-2xl font-bold text-teal-300 pixel-font">{prizePool.toFixed(2)} SOL</div>
      ...
      {isConnected && (
        <div className="clean-card text-center">
          <div className="text-2xl font-bold text-cyan-300 pixel-font">{gorBalance.toFixed(4)} SOL</div>
