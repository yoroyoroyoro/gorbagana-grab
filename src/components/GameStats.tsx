  ...
  return (
    <div className="flex flex-col sm:flex-row justify-center gap-3 sm:gap-6 lg:gap-12 mb-6">
      <div className="clean-card text-center min-w-0 flex-1 sm:flex-none">
        <div className="text-lg sm:text-xl lg:text-2xl font-bold text-teal-300 pixel-font truncate">{prizePool.toFixed(2)} GOR</div>
      ...
      {isConnected && (
        <div className="clean-card text-center min-w-0 flex-1 sm:flex-none">
          <div className="text-lg sm:text-xl lg:text-2xl font-bold text-cyan-300 pixel-font truncate">{gorBalance.toFixed(4)} GOR</div>
